            ...
            modelBuilder.Entity("FeedAggregator.DAL.Entities.FeedItem", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Content = "Some text that is content", FeedCollectionId = 1, Link = "Link1", PublishDate = new DateTime(2018, 9, 20, 19, 52, 9, 678, DateTimeKind.Local), Title = "FirstNews" },
                        new { Id = 2, Content = "Some text that is content", FeedCollectionId = 1, Link = "Link2", PublishDate = new DateTime(2018, 9, 20, 19, 52, 9, 689, DateTimeKind.Local), Title = "SecondNews" },
                        new { Id = 3, Content = "Some text that is content", FeedCollectionId = 2, Link = "Link3", PublishDate = new DateTime(2018, 9, 20, 19, 52, 9, 689, DateTimeKind.Local), Title = "ThirdNews" },
                        new { Id = 4, Content = "Some text that is content", FeedCollectionId = 2, Link = "Link4", PublishDate = new DateTime(2018, 9, 20, 19, 52, 9, 689, DateTimeKind.Local), Title = "FourthNews" }
                    );
                });
